...
const navItems = [
  ...
  { path: '/explore-business', icon: 'travel_explore', label: 'Explore Business' },
  { path: '/swot-analysis', icon: 'troubleshoot', label: 'My Business & Diagnosis' },
  { path: '/market-analysis', icon: 'query_stats', label: 'Market Analysis' },
  { path: '/financial-planner', icon: 'account_balance', label: 'Financial Planner' },
  { path: '/business-connections', icon: 'handshake', label: 'Business Connections' },
  { path: '/franchise-hub', icon: 'storefront', label: 'Franchise Hub' },
  { path: '/reports', icon: 'description', label: 'Reports & Dossier' },
  { path: '/settings', icon: 'tune', label: 'Profile & Settings' },
]
      ...
      <div className="flex flex-col">
        ...
        <div className="px-space-md pb-space-sm">
          <div className="inline-flex items-center gap-space-xs px-space-sm py-space-xs rounded-full bg-surface-container text-on-surface-variant font-label-sm text-label-sm w-full">
            ...
            <span className="truncate">WhatsApp-First AI Advisory</span>
          </div>
        </div>
