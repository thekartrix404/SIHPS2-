      ...
      <div className="px-space-lg pt-space-lg pb-space-sm flex flex-col gap-space-md">
        ...
        <div className="flex flex-wrap items-center justify-between gap-space-sm">
          ...
          <div className="inline-flex items-center gap-space-xs px-space-sm py-1 rounded-full bg-surface-container-high text-on-surface-variant font-label-sm text-label-sm shadow-sm">
            ...
            <span className="font-semibold text-on-surface">{t('liveTelemetry', 'Live Mandi & Census Telemetry:')}</span>
            <span>{t('telemetrySynced', 'Bilaspur Sub-Division, Synced 12m ago')}</span>
          </div>
        </div>
        ...
        <div className="xl:col-span-7 flex flex-col gap-space-lg">
          ...
          <div className="p-space-lg bg-surface-container-lowest rounded-xl shadow-sm flex flex-col gap-space-md">
            <div className="flex flex-wrap items-center justify-between gap-space-xs">
              <div>
                <div className="flex items-center gap-space-xs">
                  ...
                  <h2 className="font-headline-md text-headline-md text-on-surface">{t('enterpriseSnapshot', 'Current Enterprise Snapshot')}</h2>
                </div>
                <p className="font-body-sm text-body-sm text-on-surface-variant">{t('unitName', 'Suresh Agri-Processing & Cold Storage Unit • Reg: UP-RMP-2024-5821')}</p>
              </div>
              <span className="px-space-sm py-0.5 rounded-full bg-surface-container text-secondary font-label-sm text-label-sm font-semibold flex items-center gap-1">
                ...
                {t('activeOpStatus', 'Operation Status: Active')}
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-space-md">
              ...
              <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <span className="font-label-md text-label-md uppercase text-on-surface-variant">{t('monthlyRevenue', 'Monthly Gross Revenue')}</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="inline-flex items-center gap-0.5 px-space-xs py-0.5 rounded bg-primary-fixed text-on-primary-fixed font-label-sm text-label-sm font-bold">
                    ...
                    {t('momRevenue', '+12.4% MoM')}
                  </span>
                  <span className="font-body-sm text-body-sm text-on-surface-variant">{t('vsPrevMonth', 'vs. Prev Month')}</span>
                </div>
              </div>
              ...
              <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <span className="font-label-md text-label-md uppercase text-on-surface-variant">{t('monthlyExpenses', 'Operational Expenses')}</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="font-body-sm text-body-sm text-on-surface font-semibold">{t('netMargin', 'Net Operating Margin: 18.2%')}</span>
                  <span className="font-body-sm text-body-sm text-secondary">{t('surplusTag', '₹63,000 Surplus')}</span>
                </div>
              </div>
              ...
              <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <span className="font-label-md text-label-md uppercase text-on-surface-variant">{t('activeBuyers', 'Active B2B Buyers')}</span>
                ...
                <div className="my-space-xs flex items-baseline gap-space-xs">
                  ...
                  <span className="font-body-sm text-body-sm text-on-surface-variant">{t('accountsInBilaspur', 'accounts in Bilaspur')}</span>
                </div>
                <div className="flex items-center gap-space-xs font-label-sm text-label-sm text-on-surface-variant">
                  <span className="px-space-xs py-0.5 rounded bg-surface-container font-semibold text-on-surface">{t('localShops', '14 Local Shops')}</span>
                  <span className="px-space-xs py-0.5 rounded bg-surface-container font-semibold text-on-surface">{t('wholesale', '7 Wholesale')}</span>
                </div>
              </div>
              ...
              <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <span className="font-label-md text-label-md uppercase text-on-surface-variant">{t('processingCapacity', 'Processing Capacity')}</span>
                  <span className="p-1 rounded bg-surface-container-lowest text-primary">
                ...
                <div className="my-space-xs flex items-baseline justify-between">
                  ...
                  <span className="font-body-sm text-body-sm text-on-surface-variant">{t('capacityRatio', '500kg of 800kg/day')}</span>
                </div>
                <div>
                  ...
                  <span className="font-body-sm text-body-sm text-on-surface-variant mt-1 block">{t('idleCapacity', '300kg idle capacity available')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-space-md bg-surface-container rounded-lg">
              <div className="flex items-center justify-between mb-space-xs">
                <span className="font-label-md text-label-md text-on-surface font-semibold">{t('weeklyCashFlow', 'Weekly Cash Flow Comparison (Last 4 Weeks)')}</span>
                <div className="flex items-center gap-space-md font-label-sm text-label-sm">
                  <span className="flex items-center gap-1 text-on-surface-variant"><span className="w-2.5 h-2.5 rounded bg-primary"></span> {t('revenue', 'Revenue')}</span>
                  <span className="flex items-center gap-1 text-on-surface-variant"><span className="w-2.5 h-2.5 rounded bg-surface-dim"></span> {t('expenses', 'Expenses')}</span>
                </div>
              </div>
          ...
          <div className="p-space-lg bg-surface-container-lowest rounded-xl shadow-sm flex flex-col gap-space-md">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-space-xs">
                ...
                <h2 className="font-headline-md text-headline-md text-on-surface">{t('aiDirectives', 'Targeted AI Business Directives')}</h2>
              </div>
              <span className="font-label-sm text-label-sm text-on-surface-variant font-semibold">{t('ragGrounded', 'RAG-Grounded • Scheme-Matched')}</span>
            </div>
            <div className="flex flex-col gap-space-md">
              ...
              <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-space-md hover:bg-surface-container transition-all">
                <div className="flex items-start gap-space-md">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-space-xs">
                      <span className="font-headline-sm text-headline-sm text-on-surface font-semibold">{t('pmegpMatch', 'PMEGP Scheme — Perfect Match')}</span>
                      <span className="px-space-xs py-0.5 rounded bg-primary-container text-on-primary-container font-label-sm text-label-sm font-bold">{t('subsidy25', '25% Subsidy')}</span>
                    </div>
                    <p className="font-body-md text-body-md text-on-surface-variant mt-1">
                      {t('pmegpDesc', 'Your agri-processing unit qualifies for PMEGP subsidy of ₹2.5L on a ₹10L project outlay. With your existing ₹1L equity, you can unlock ₹6.5L bank term loan at 8% p.a.')}
                    </p>
                    <div className="flex items-center gap-space-md mt-space-xs text-on-surface-variant font-label-sm text-label-sm">
                      <span>{t('subsidyAmt', 'Subsidy: ₹2,50,000')}</span>
                      <span>•</span>
                      <span>{t('emiDetail', 'EMI: ~₹9,400/mo for 7 years')}</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-space-md hover:bg-surface-container transition-all">
                <div className="flex items-start gap-space-md">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-space-xs">
                      <span className="font-headline-sm text-headline-sm text-on-surface font-semibold">{t('excessCapacity', 'Utilize 300kg Excess Processing Capacity')}</span>
                      <span className="px-space-xs py-0.5 rounded bg-secondary-fixed text-on-secondary-fixed font-label-sm text-label-sm font-bold">{t('capacityAlpha', 'Capacity Alpha')}</span>
                    </div>
                    <p className="font-body-md text-body-md text-on-surface-variant mt-1">
                      {t('excessCapacityDesc', 'Your cold storage unit operates with idle overhead between 6:00 PM and 6:00 AM. It can readily support value-added processing batches — flour packaging or spice grinding.')}
                    </p>
                    <div className="flex items-center gap-space-md mt-space-xs text-on-surface-variant font-label-sm text-label-sm">
                      <span>{t('capexNeeded', 'Capex Needed: Minimal (Grinder ₹35k)')}</span>
                      <span>•</span>
                      <span>{t('valueAddSpread', 'Value-Add Spread: +28%')}</span>
                    </div>
                  </div>
                </div>
                <Link to="/market-analysis" className="shrink-0 w-full md:w-auto px-space-md py-space-xs bg-secondary text-on-secondary font-label-lg text-label-lg rounded-lg shadow-sm hover:bg-on-secondary-container transition-all text-center inline-flex items-center justify-center gap-1">
                  <span>{t('modelValueAddition', 'Model Value-Addition')}</span>
                  <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
                </Link>
              </div>
              ...
              <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-space-md hover:bg-surface-container transition-all">
                <div className="flex items-start gap-space-md">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-space-xs">
                      <span className="font-headline-sm text-headline-sm text-on-surface font-semibold">{t('fpoProcurement', 'FPO Bulk Procurement Match')}</span>
                      <span className="px-space-xs py-0.5 rounded bg-surface-container-high text-on-surface-variant font-label-sm text-label-sm font-bold">{t('costReduction', '12% Cost Reduction')}</span>
                    </div>
                    <p className="font-body-md text-body-md text-on-surface-variant mt-1">
                      {t('fpoDesc', 'Located within 6.2 km. Group procurement through BizOrbit enables direct delivery of raw wheat with zero distributor markup.')}
                    </p>
                    <div className="flex items-center gap-space-md mt-space-xs text-on-surface-variant font-label-sm text-label-sm">
                      <span>{t('fpoVerified', 'Verified Entity: FPO-UP-0881')}</span>
                      <span>•</span>
                      <span>{t('monthlySavings', 'Monthly Savings: ₹8,400')}</span>
                    </div>
                  </div>
                </div>
                <Link to="/market-analysis" className="shrink-0 w-full md:w-auto px-space-md py-space-xs bg-surface-container-lowest text-on-surface font-label-lg text-label-lg rounded-lg shadow-sm hover:bg-surface-container transition-all text-center inline-flex items-center justify-center gap-1 border border-outline/10">
                  <span>{t('viewSupplierMatch', 'View Supplier Match')}</span>
                  <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
                </Link>
              </div>
            </div>
          ...
          <div className="p-space-lg bg-surface-container-lowest rounded-xl shadow-sm flex flex-col gap-space-md">
            ...
            <div className="grid grid-cols-2 gap-space-sm">
              <div className="p-space-sm bg-surface-container-low rounded-lg flex flex-col">
                ...
                <span className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1">{t('citizens', '14,800 Citizens')}</span>
                <span className="font-body-sm text-body-sm text-on-surface-variant">{t('panchayats', 'Across 14 Panchayats')}</span>
              </div>
              <div className="p-space-sm bg-surface-container-low rounded-lg flex flex-col">
                <span className="font-label-sm text-label-sm text-on-surface-variant uppercase">{t('captiveDemand', 'Captive Daily Demand')}</span>
                <span className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1">{t('captiveDailyVal', '800 kg / Day')}</span>
                <span className="font-body-sm text-body-sm text-secondary font-semibold">{t('unmetDemand', '~62% Unmet by organized units')}</span>
              </div>
            </div>
              ...
              <div className="w-full h-full bg-gradient-to-br from-primary/10 via-surface-container to-secondary/10 flex flex-col justify-between p-space-sm">
                <div className="flex justify-between items-start">
                  <div className="inline-flex items-center gap-space-xs px-space-sm py-1 rounded bg-surface-container-lowest/90 backdrop-blur-md shadow-sm">
                    ...
                    <span className="font-label-sm text-label-sm text-on-surface font-bold">{t('bilaspurHub', 'Bilaspur Processing Hub (Current)')}</span>
                  </div>
                ...
                <div className="p-space-xs rounded-lg bg-surface-container-lowest/95 backdrop-blur-md shadow-sm flex items-center justify-around text-center">
                  <div>
                    <span className="block font-label-sm text-label-sm font-bold text-primary">{t('unitPer8km', '1 Unit / 8km')}</span>
                  ...
                  <div>
                    <span className="block font-label-sm text-label-sm font-bold text-secondary">{t('points3', '3 Collection Points')}</span>
                    <span className="block text-[10px] text-on-surface-variant font-label-sm">{t('collectionPoints', 'Collection Points')}</span>
                  </div>
                  <div className="w-px h-6 bg-surface-container-high"></div>
                  <div>
                    <span className="block font-label-sm text-label-sm font-bold text-tertiary">{t('nh87', 'NH-87 Corridor')}</span>
            ...
            <div className="p-space-sm rounded-lg bg-surface-container flex items-center gap-space-sm">
              ...
              <div className="flex-1 text-body-sm font-body-sm text-on-surface">
                <strong>{t('favorableMarketGapBold', 'Favorable Market Gap:')}</strong> {t('favorableMarketGapText', 'Nearest competitor is 8.4 km away. High village aggregation exclusivity.')}
              </div>
            </div>
            <Link
              to="/market-analysis"
          ...
          <div className="p-space-lg bg-surface-container-lowest rounded-xl shadow-sm flex flex-col gap-space-md">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-space-xs">
                ...
                <h2 className="font-headline-md text-headline-md text-on-surface">{t('finHealthTitle', 'Financial Health & Scheme')}</h2>
              </div>
              <span className="font-label-sm text-label-sm px-space-xs py-0.5 rounded bg-surface-container-high text-on-surface font-semibold">{t('pmegpTermUnit', 'PMEGP Term Unit')}</span>
            </div>
            <div className="p-space-md bg-surface-container-low rounded-lg flex flex-col gap-space-sm">
              <div className="flex items-center justify-between">
                <span className="font-label-sm text-label-sm uppercase text-on-surface-variant">{t('approvedOutlay', 'Approved Project Outlay')}</span>
              ...
              <div className="grid grid-cols-3 gap-space-xs pt-space-xs text-center">
                <div className="flex flex-col">
                  <span className="text-[11px] font-label-sm text-on-surface-variant">{t('ownEquityLabel', 'Own Equity (10%)')}</span>
                  <span className="font-label-md text-label-md font-semibold text-primary">₹1,00,000</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-[11px] font-label-sm text-on-surface-variant">{t('pmegpSubsidyLabel', 'PMEGP Subsidy (25%)')}</span>
                  <span className="font-label-md text-label-md font-semibold text-secondary">₹2,50,000</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-[11px] font-label-sm text-on-surface-variant">{t('bankLoanLabel', 'Bank Loan (65%)')}</span>
            ...
            <div className="flex flex-col gap-space-sm">
              {[
                { icon: 'savings', label: t('mudraLoan', 'Mudra Loan'), status: t('preQualified', 'Pre-Qualified'), statusColor: 'text-secondary bg-secondary-container', detail: t('mudraDetail', '₹50,000 – ₹10,00,000 • 7.9% p.a.') },
                { icon: 'volunteer_activism', label: t('standUpIndia', 'Stand-Up India'), status: t('checkEligibility', 'Check Eligibility'), statusColor: 'text-on-surface-variant bg-surface-container-high', detail: t('standUpDetail', '₹10L – ₹1Cr for SC/ST/Women') },
                { icon: 'account_balance_wallet', label: t('pmSvanidhi', 'PM SVANidhi'), status: t('notApplicable', 'Not Applicable'), statusColor: 'text-on-surface-variant bg-surface-container', detail: t('pmSvanidhiDetail', 'For street vendors — not matched') },
              ].map(scheme => (
          ...
          <div className="p-space-lg bg-surface-container-lowest rounded-xl shadow-sm flex flex-col gap-space-md">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-space-xs">
                ...
                <h2 className="font-headline-md text-headline-md text-on-surface">{t('whatsappChannel', 'WhatsApp Advisory Channel')}</h2>
              </div>
            ...
            <div className="bg-surface-container-low rounded-lg p-space-md flex flex-col gap-space-sm">
              <div className="flex gap-space-sm">
                ...
                <div className="bg-surface-container-lowest p-space-sm rounded-lg rounded-tl-none max-w-[80%] shadow-sm">
                  <p className="font-body-md text-body-md text-on-surface">{t('waMsg1', 'नमस्ते सुरेश जी! 🙏 आपकी agri-processing unit की feasibility report तैयार है। PMEGP subsidy ₹2.5L approved हो सकती है।')}</p>
              ...
              <div className="flex gap-space-sm justify-end">
                <div className="bg-primary-fixed p-space-sm rounded-lg rounded-tr-none max-w-[80%] shadow-sm">
                  <p className="font-body-md text-body-md text-on-primary-fixed">{t('waMsg2', 'Haan ji, documents kya chahiye?')}</p>
              ...
              <div className="flex gap-space-sm">
                ...
                <div className="bg-surface-container-lowest p-space-sm rounded-lg rounded-tl-none max-w-[80%] shadow-sm">
                  <p className="font-body-md text-body-md text-on-surface">{t('waMsg3', 'आपको चाहिए: ✅ Aadhaar Card ✅ Udyam Registration ✅ Bank Statement (6 months) ✅ Gram Panchayat NOC — मैं checklist PDF भेज रहा हूँ 📄')}</p>
            ...
            <button className="w-full py-space-sm bg-secondary text-on-secondary rounded-lg font-label-lg text-label-lg shadow-sm hover:bg-on-secondary-container transition-all flex items-center justify-center gap-space-xs">
              ...
              {t('openWhatsApp', 'Open WhatsApp Channel')}
            </button>
          </div>
        </div>
      </div>
